...
const components: Record<IconType, { module: null | SVG; load: () => Promise<SVG> }> = {
  spinner: {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-spinner.svg').then((it) => it.default),
  },
  chat: {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-chat.svg').then((it) => it.default),
  },
  message: {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-message.svg').then((it) => it.default),
  },
  error: {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-error.svg').then((it) => it.default),
  },
  refresh: {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-refresh.svg').then((it) => it.default),
  },
  'chevron-down': {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-chevron-down.svg').then((it) => it.default),
  },
  'feedback-like': {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-feedback-like.svg').then((it) => it.default),
  },
  'feedback-dislike': {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-feedback-dislike.svg').then((it) => it.default),
  },
  'done': {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-done.svg').then((it) => it.default),
  },
  'file-document': {
    module: null,
    load: () => import('@sendbird/uikit-react/src/svgs/icon-file-document.svg').then((it) => it.default),
  },
};
