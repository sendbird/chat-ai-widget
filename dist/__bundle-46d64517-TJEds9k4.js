import { d as g } from "./index-D_SjlShX.js";
function L(e, t) {
    ...
    if (typeof s != "string" && !Array.isArray(s)) {
      for (const n in s)
        if (n !== "default" && !(n in e)) {
          ...
          r && Object.defineProperty(e, n, r.get ? r : { enumerable: !0, get: () => s[n] });
        }
    }
  }
  return Object.freeze(Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }));
}
var x = {}, h = typeof globalThis < "u" && globalThis || typeof self < "u" && self || g !== void 0 && g || {}, P = "URLSearchParams" in h, S = "Symbol" in h && "iterator" in Symbol, m = "FileReader" in h && "Blob" in h && function() {
  try {
    return new Blob(), !0;
  } catch {
    return !1;
  }
}(), j = "FormData" in h, v = "ArrayBuffer" in h;
if (v)
  var q = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"], N = ArrayBuffer.isView || function(e) {
    return e && q.indexOf(Object.prototype.toString.call(e)) > -1;
  };
function l(e) {
...
function R() {
  return this.bodyUsed = !1, this._initBody = function(e) {
    ...
    if (this._bodyArrayBuffer)
      return T(this) || (ArrayBuffer.isView(this._bodyArrayBuffer) ? Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset, this._bodyArrayBuffer.byteOffset + this._bodyArrayBuffer.byteLength)) : Promise.resolve(this._bodyArrayBuffer));
    if (m)
      return this.blob().then(k);
    throw new Error("could not read as ArrayBuffer");
  }, this.text = function() {
    var e, t, o, s, n, r = T(this);
    if (r)
      return r;
    if (this._bodyBlob)
      return e = this._bodyBlob, o = F(t = new FileReader()), n = (s = /charset=([A-Za-z0-9_-]+)/.exec(e.type)) ? s[1] : "utf-8", t.readAsText(e, n), o;
    if (this._bodyArrayBuffer)
...
}, S && (i.prototype[Symbol.iterator] = i.prototype.entries);
...
function d(e, t) {
  ...
  if (e instanceof d) {
    ...
    this.url = String(e);
  if (this.credentials = t.credentials || this.credentials || "same-origin", !t.headers && this.headers || (this.headers = new i(t.headers)), this.method = (s = (o = t.method || this.method || "GET").toUpperCase(), G.indexOf(s) > -1 ? s : o), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || function() {
...
`) === 0 ? y.substr(1, y.length) : y;
      ...
      n.url.indexOf("file://") === 0 && (r.status < 200 || r.status > 599) ? b.status = 200 : b.status = r.status, b.url = "responseURL" in r ? r.responseURL : b.headers.get("X-Request-URL");
    ...
    }(n.url), !0), n.credentials === "include" ? r.withCredentials = !0 : n.credentials === "omit" && (r.withCredentials = !1), "responseType" in r && (m ? r.responseType = "blob" : v && (r.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof i || h.Headers && t.headers instanceof h.Headers)) {
      var c = [];
      Object.getOwnPropertyNames(t.headers).forEach(function(a) {
        c.push(l(a)), r.setRequestHeader(a, _(t.headers[a]));
...
E.polyfill = !0, h.fetch || (h.fetch = E, h.Headers = i, h.Request = d, h.Response = f);
var D = typeof globalThis < "u" && globalThis || typeof self < "u" && self || g !== void 0 && g || { fetch: null };
D.fetch || (D.fetch = E);
const X = L({ __proto__: null, default: x }, [x]);
export {
  X as _
};
